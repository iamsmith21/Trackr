            ...
            <div className="space-y-3 flex flex-col grow overflow-y-auto">
              {columnJobs.map((j) => (
                <div
                  ...
                  className="bg-white dark:bg-[#121214] border border-[#162518]/10 dark:border-white/10 rounded-xl p-4 shadow-sm hover:shadow-md hover:border-emerald-500/30 active:scale-[0.98] transition-all duration-200 cursor-grab active:cursor-grabbing"
                >
                  <Link
                    to={`/jobs/${j.id}`}
                  ...
                  <p className="text-xs font-semibold text-slate-500 dark:text-[#86868B] mb-4">
                    {j.company}
                  </p>
              ...
              {columnJobs.length === 0 && (
                <div className="h-24 border border-dashed border-slate-200 dark:border-white/5 rounded-xl flex items-center justify-center text-slate-300 dark:text-white/10 text-xs font-semibold select-none">
                  No jobs here
                </div>
              )}
            </div>
