  ...
  return (
    ...
    <nav className="sticky top-0 z-50 w-full bg-white/70 dark:bg-[#161617]/70 backdrop-blur-md border-b border-slate-200/60 dark:border-white/10 px-6 py-4 flex items-center justify-between transition-all duration-300">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
        onClick={onAddClick}
        className="bg-blue-600 hover:bg-blue-700 active:scale-95 text-white text-sm font-semibold px-4 py-2.5 rounded-xl shadow-lg shadow-blue-500/10 hover:shadow-blue-500/20 transition-all duration-300 cursor-pointer flex items-center gap-1.5">
